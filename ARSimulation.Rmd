...
```
Now we can find the mean of this bootstrap, repeat the process many times, and find the point estimate for the mean and the standard error of the distribution.
```{r, echo = False}
bootstrap_samp2 <- function(ts.series, B, b)
{
  point1 <- sample(c(1:length(ts.series)), 1, replace = T)
