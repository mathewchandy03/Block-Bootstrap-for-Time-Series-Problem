...
```{r functions, echo = False}
set.seed(5)
o = my_summary(replicate(4000, do1rep2(400, 0, 0.1, 20, m1)))
root_norm_1 <- data.frame(c(400, 20, o))
for(l in 19:16)
{
  set.seed(5)
  n = l^2
  t = my_summary(replicate(4000, do1rep2(n, 0, 0.1, l, m1)))
...
```{r functions, echo = False}
set.seed(5)
o = my_summary(replicate(4000, do1rep2(225, 0, 0.1, 15, m1)))
...
```{r functions, echo = False}
set.seed(5)
o = my_summary(replicate(4000, do1rep2(100, 0, 0.1, 10, m1)))
...
```{r functions, echo = False}
set.seed(5)
o = my_summary(replicate(4000, do1rep(400, 0, 0.1, 20, m1)))
root_0_1 <- data.frame(c(400, 20, o))
for(l in 19:16)
{
  set.seed(5)
  n = l^2
  t = my_summary(replicate(4000, do1rep(n, 0, 0.1, l, m1)))
...
```{r functions, echo = False}
set.seed(5)
o = my_summary(replicate(4000, do1rep(225, 0, 0.1, 15, m1)))
...
```{r functions, echo = False}
set.seed(5)
o = my_summary(replicate(4000, do1rep(100, 0, 0.1, 10, m1)))
...
```{r functions, echo = False}
set.seed(5)
o = my_summary(replicate(4000, do1rep(400, 0.2, 0.1, 20, m1)))
root_0.2_1 <- data.frame(c(400, 20, o))
for(l in 19:16)
{
  set.seed(5)
  n = l^2
  t = my_summary(replicate(4000, do1rep(n, 0.2, 0.1, l, m1)))
...
```{r functions, echo = False}
set.seed(5)
o = my_summary(replicate(4000, do1rep(225, 0.2, 0.1, 15, m1)))
...
```{r functions, echo = False}
set.seed(5)
o = my_summary(replicate(4000, do1rep(100, 0.2, 0.1, 10, m1)))
...
```{r functions, echo = False}
set.seed(5)
o = my_summary(replicate(4000, do1rep(625, 0.4, 0.1, 25, m1)))
root_0.4_1 <- data.frame(c(625, 25, o))
for(l in 24:21)
{
  set.seed(5)
  n = l^2
  t = my_summary(replicate(4000, do1rep(n, 0.4, 0.1, l, m1)))
...
```{r functions, echo = False}
set.seed(5)
o = my_summary(replicate(4000, do1rep(400, 0.4, 0.1, 20, m1)))
...
```{r functions, echo = False}
set.seed(5)
o = my_summary(replicate(4000, do1rep(225, 0.4, 0.1, 15, m1)))
...
```{r functions, echo = False}
set.seed(5)
o = my_summary(replicate(4000, do1rep(100, 0.4, 0.1, 10, m1)))
...
```{r functions, echo = False}
set.seed(5)
o = my_summary(replicate(4000, do1rep(900, 0.6, 0.1, 30, m1)))
root_0.6_1 <- data.frame(c(900, 30, o))
for(l in 29:26)
{
  set.seed(5)
  n = l^2
  t = my_summary(replicate(4000, do1rep(n, 0.6, 0.1, l, m1)))
...
```{r functions, echo = False}
set.seed(5)
o = my_summary(replicate(4000, do1rep(625, 0.6, 0.1, 25, m1)))
...
```{r functions, echo = False}
set.seed(5)
o = my_summary(replicate(4000, do1rep(400, 0.6, 0.1, 20, m1)))
...
```{r functions, echo = False}
set.seed(5)
o = my_summary(replicate(4000, do1rep(225, 0.6, 0.1, 15, m1)))
...
```{r functions, echo = False}
set.seed(5)
o = my_summary(replicate(4000, do1rep2(400, 0, 0.1, 10, m1)))
constant_norm_1 <- data.frame(c(400, 10, o))
for(m in 19:16)
{
  set.seed(5)
  n = 20 * m
  t = my_summary(replicate(4000, do1rep2(n, 0, 0.1, 10, m1)))
...
```{r functions, echo = False}
set.seed(5)
o = my_summary(replicate(4000, do1rep2(300, 0, 0.1, 10, m1)))
...
```{r functions, echo = False}
set.seed(5)
o = my_summary(replicate(4000, do1rep2(200, 0, 0.1, 10, m1)))
...
```{r functions, echo = False}
set.seed(5)
o = my_summary(replicate(4000, do1rep(400, 0, 0.1, 10, m1)))
constant_0_1 <- data.frame(c(400, 10, o))
for(m in 19:16)
{
  set.seed(5)
  n = 20 * m
  t = my_summary(replicate(4000, do1rep(n, 0, 0.1, 10, m1)))
...
```{r functions, echo = False}
set.seed(5)
o = my_summary(replicate(4000, do1rep(300, 0, 0.1, 10, m1)))
...
```{r functions, echo = False}
set.seed(5)
o = my_summary(replicate(4000, do1rep(200, 0, 0.1, 10, m1)))
...
```{r functions, echo = False}
set.seed(5)
o = my_summary(replicate(4000, do1rep(400, 0.2, 0.1, 10, m1)))
constant_0.2_1 <- data.frame(c(400, 10, o))
for(m in 19:16)
{
  set.seed(5)
  n = 20 * m
  t = my_summary(replicate(4000, do1rep(n, 0.2, 0.1, 10, m1)))
...
```{r functions, echo = False}
set.seed(5)
o = my_summary(replicate(4000, do1rep(300, 0.2, 0.1, 10, m1)))
...
```{r functions, echo = False}
set.seed(5)
o = my_summary(replicate(4000, do1rep(200, 0.2, 0.1, 10, m1)))
...
```{r functions, echo = False}
set.seed(5)
o = my_summary(replicate(4000, do1rep(600, 0.4, 0.1, 10, m1)))
constant_0.4_1 <- data.frame(c(600, 10, o))
for(m in 29:26)
{
  set.seed(5)
  n = 20 * m
  t = my_summary(replicate(4000, do1rep(n, 0.4, 0.1, 10, m1)))
...
```{r functions, echo = False}
set.seed(5)
o = my_summary(replicate(4000, do1rep(500, 0.4, 0.1, 10, m1)))
...
```{r functions, echo = False}
set.seed(5)
o = my_summary(replicate(4000, do1rep(400, 0.4, 0.1, 10, m1)))
...
```{r functions, echo = False}
set.seed(5)
o = my_summary(replicate(4000, do1rep(300, 0.4, 0.1, 10, m1)))
...
```{r functions, echo = False}
set.seed(5)
o = my_summary(replicate(4000, do1rep(200, 0.4, 0.1, 10, m1)))
...
```{r functions, echo = False}
set.seed(5)
o = my_summary(replicate(4000, do1rep(900, 0.6, 0.1, 10, m1)))
constant_0.6_1 <- data.frame(c(900, 10, o))
for(m in 44:41)
{
  set.seed(5)
  n = 20 * m
  t = my_summary(replicate(4000, do1rep(n, 0.6, 0.1, 10, m1)))
...
```{r functions, echo = False}
set.seed(5)
o = my_summary(replicate(4000, do1rep(800, 0.6, 0.1, 10, m1)))
...
```{r functions, echo = False}
set.seed(5)
o = my_summary(replicate(4000, do1rep(700, 0.6, 0.1, 10, m1)))
...
```{r functions, echo = False}
set.seed(5)
o = my_summary(replicate(4000, do1rep(600, 0.6, 0.1, 10, m1)))
...
```{r functions, echo = False}
set.seed(5)
o = my_summary(replicate(4000, do1rep(500, 0.6, 0.1, 10, m1)))
...
```{r functions, echo = False}
set.seed(5)
o = my_summary(replicate(4000, do1rep(400, 0.6, 0.1, 10, m1)))
...
```{r functions, echo = False}
set.seed(5)
o = my_summary(replicate(4000, do1rep(300, 0.6, 0.1, 10, m1)))
...
```{r functions, echo = False}
set.seed(5)
o = my_summary(replicate(4000, do1rep(200, 0.6, 0.1, 10, m1)))
...
```{r}
library(xtable)
table_root_norm <- root_norm
table_root_norm$lb <- format(round(table_root_norm$lb, 5), 5)
table_root_norm$ub <- format(round(table_root_norm$ub, 5), 5)
table_root_norm$coverage_rate <- format(table_root_norm$coverage_rate, 5)
table_root_norm$interval <- paste(table_root_norm$coverage_rate, '(', table_root_norm$lb, ',', table_root_norm$ub, ')')
table_root_norm = subset(table_root_norm, select = -c(coverage_rate, lb, ub) )
colnames(table_root_norm) <- c("Sample Size, "Block Length", 'Method', 'Coverage Rate')
table_root_norm <- table_root_norm[order(-table_root_norm$`Time Series Length`), ]
row.names(table_root_norm) <- NULL
table_root_norm
xtable(table_root_norm)
```
```{r}
library(xtable)
table_root_0.2 <- root_0.2
table_root_0.2$lb <- format(round(table_root_0.2$lb, 5), 5)
table_root_0.2$ub <- format(round(table_root_0.2$ub, 5), 5)
table_root_0.2$coverage_rate <- format(table_root_0.2$coverage_rate, 5)
table_root_0.2$interval <- paste(table_root_0.2$coverage_rate, '(', table_root_0.2$lb, ',', table_root_0.2$ub, ')')
table_root_0.2 = subset(table_root_0.2, select = -c(coverage_rate, lb, ub) )
colnames(table_root_0.2) <- c("Sample Size", "Block Length", 'Method', 'Coverage Rate')
table_root_0.2 <- table_root_0.2[order(-table_root_0.2$`Time Series Length`), ]
row.names(table_root_0.2) <- NULL
table_root_0.2
xtable(table_root_0.2)
```
```{r}
library(xtable)
table_root_0.4 <- root_0.4
table_root_0.4$lb <- format(round(table_root_0.4$lb, 5), 5)
table_root_0.4$ub <- format(round(table_root_0.4$ub, 5), 5)
table_root_0.4$ci <- format(table_root_0.4$ci, 5)
table_root_0.4$interval <- paste(table_root_0.4$ci, '(', table_root_0.4$lb, ',', table_root_0.4$ub, ')')
table_root_0.4 = subset(table_root_0.4, select = -c(ci, lb, ub) )
colnames(table_root_0.4) <- c("Sample Size", "Block Length", 'Method', 'Coverage Rate')
table_root_0.4 <- table_root_0.4[order(-table_root_0.4$`Time Series Length`), ]
row.names(table_root_0.4) <- NULL
table_root_0.4
xtable(table_root_0.4)
```
```{r}
library(xtable)
table_root_0.6 <- root_0.6
table_root_0.6$lb <- format(round(table_root_0.6$lb, 5), 5)
table_root_0.6$ub <- format(round(table_root_0.6$ub, 5), 5)
table_root_0.6$ci <- format(table_root_0.6$ci, 5)
table_root_0.6$interval <- paste(table_root_0.6$ci, '(', table_root_0.6$lb, ',', table_root_0.6$ub, ')')
table_root_0.6 = subset(table_root_0.6, select = -c(ci, lb, ub) )
colnames(table_root_0.6) <- c("Sample Size", "Block Length", 'Method', 'Coverage Rate')
table_root_0.6 <- table_root_0.6[order(-table_root_0.6$`Time Series Length`), ]
row.names(table_root_0.6) <- NULL
table_root_0.6
xtable(table_root_0.6)
```
```{r}
library(xtable)
table_constant_norm <- constant_norm
table_constant_norm$lb <- format(round(table_constant_norm$lb, 5), 5)
table_constant_norm$ub <- format(round(table_constant_norm$ub, 5), 5)
table_constant_norm$ci <- format(table_constant_norm$ci, 5)
table_constant_norm$interval <- paste(table_constant_norm$ci, '(', table_constant_norm$lb, ',', table_constant_norm$ub, ')')
table_constant_norm = subset(table_constant_norm, select = -c(ci, lb, ub) )
colnames(table_constant_norm) <- c("Sample Size", "Block Length", 'Method', 'Coverage Rate')
table_constant_norm <- table_constant_norm[order(-table_constant_norm$`Sample Size`), ]
row.names(table_constant_norm) <- NULL
table_constant_norm
xtable(table_constant_norm)
```

```{r}
library(xtable)
table_constant_0.2 <- constant_0.2
table_constant_0.2$lb <- format(round(table_constant_0.2$lb, 5), 5)
table_constant_0.2$ub <- format(round(table_constant_0.2$ub, 5), 5)
table_constant_0.2$ci <- format(table_constant_0.2$ci, 5)
table_constant_0.2$interval <- paste(table_constant_0.2$ci, '(', table_constant_0.2$lb, ',', table_constant_0.2$ub, ')')
table_constant_0.2 = subset(table_constant_0.2, select = -c(ci, lb, ub) )
colnames(table_constant_0.2) <- c("Sample Length", "Block Length", 'Method', 'Coverage Rate')
table_constant_0.2 <- table_constant_0.2[order(-table_constant_0.2$`Sample Length`), ]
row.names(table_constant_0.2) <- NULL
table_constant_0.2
xtable(table_constant_0.2)
```
```{r}
library(xtable)
table_constant_0.4 <- constant_0.4
table_constant_0.4$lb <- format(round(table_constant_0.4$lb, 5), 5)
table_constant_0.4$ub <- format(round(table_constant_0.4$ub, 5), 5)
table_constant_0.4$ci <- format(table_constant_0.4$ci, 5)
table_constant_0.4$interval <- paste(table_constant_0.4$ci, '(', table_constant_0.4$lb, ',', table_constant_0.4$ub, ')')
table_constant_0.4 = subset(table_constant_0.4, select = -c(ci, lb, ub) )
colnames(table_constant_0.4) <- c("Sample Length", "Block Length", 'Method', 'Coverage Rate')
table_constant_0.4 <- table_constant_0.4[order(-table_constant_0.4$`Sample Length`), ]
row.names(table_constant_0.4) <- NULL
table_constant_0.4
xtable(table_constant_0.4)
```
```{r}
library(xtable)
table_constant_0.6 <- constant_0.6
table_constant_0.6$lb <- format(round(table_constant_0.6$lb, 5), 5)
table_constant_0.6$ub <- format(round(table_constant_0.6$ub, 5), 5)
table_constant_0.6$ci <- format(table_constant_0.6$ci, 5)
table_constant_0.6$interval <- paste(table_constant_0.6$ci, '(', table_constant_0.6$lb, ',', table_constant_0.6$ub, ')')
table_constant_0.6 = subset(table_constant_0.6, select = -c(ci, lb, ub) )
colnames(table_constant_0.6) <- c("Sample Length", "Block Length", 'Method', 'Coverage Rate')
table_constant_0.6 <- table_constant_0.6[order(-table_constant_0.6$`Sample Length`), ]
row.names(table_constant_0.6) <- NULL
table_constant_0.6
xtable(table_constant_0.6)
```