...
undercoverage. We have discussed this in the third paragraph of the Marginal 
Standard Normal 
...
y-axis without hurting the visualization for the other rows. The other reviewer
suggested that we put the 6 figures in a column in 
a single plot.
Figure~\ref{fig:alt2_norm1} is provided as an example of this with fixed limits:
