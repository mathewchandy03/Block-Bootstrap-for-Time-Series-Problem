...
Standard, Percentile, CBP, Centered, and $BC$ CIs seem to 
...
be enough to recover $\mu$ when using Standard, Percentile, CBP, Centered, or $BC$ 
...
$\phi = -0.2$, Standard and Centered CIs recover $\phi$ at $n = 800$ and 
$n = 1600$, 
...
$\phi = 0$, Standard and Centered CIs recover $\phi$ relatively comfortably 
at $n = 3200$, and 
$n = 800$ seems to be sufficient for Student's $t$ CIs. For $\phi = 0.2$, Standard
and Centered CIs cover $\phi$ at the nominal rate for $n \geq 1600$, whereas 
...
estimating $\phi$ only for Standard, Student's $t$, and Centered CIs, whereas 
...
underestimates $\phi$, the coverage decreases. The $BC_a$ CI does seem to correct the bias, but the acceleration factor seems to fail, as the width of the CI
seems to be inconsistent. 


When using Student's $t$ centered intervals and $\phi$ is
