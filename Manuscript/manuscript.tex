...
autocorrelation coefficients are $\{-0.298, -0.156, 0, 0.170, 0.355\}$.
...
\begin{figure}[tbp]
  ...
  \caption{Empirical coverage rates of different 95\% block bootstrap CIs for
    the marginal standard deviation $\sigma_x$ of a stationary series with 
...
\begin{figure}[tbp]
  ...
  \caption{Empirical coverage rates of different 95\% block bootstrap CIs for 
    the first-order autocorrelation coefficient $\phi$ of a stationary series
