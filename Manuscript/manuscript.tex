...
the standard deviation. Finally, to estimate the lag-1 autocorrelation, using
Student's $t$ bootstrap confidence intervals demands a sample size of at least 100 
when the marginal distribution is standard normal and a sample size of at least 1600 when
the marginal distribution is unit exponential.
