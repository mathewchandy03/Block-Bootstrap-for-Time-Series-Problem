...
estimates from bootstrap in small samples may be more accurate than
...
$n = 1024$.
Also in the setting of linear regression, but focused on estimating the proportion of 
...
\citet{chernick2009revisiting} finds that the the best choice of method for estimating
the parameter of a distribution is dependent on the sample size, the number of
bootstrap resamples, and the confidence level.
...
The procedure for constructing a Centered Percentile CI - referred to as
a Non-Studentized pivotal method - is described in \citet{carpenter2000bootstrap}.
