...
the block bootstrap would begin to consistently return coverage rates below .90. For AR = 0.2 using a constant l, results for
...
As the AR Coefficient increases, it was found unsurprisingly that a larger sample size was required for effective block bootstrap estimation. 
