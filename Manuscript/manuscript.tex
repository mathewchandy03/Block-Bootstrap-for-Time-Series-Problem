...
to infinity. \citep{calhoun2018} In practice, however, it is necessary to know 
...
\eds{The motivation behind proposing such an interval was based on the 
...
\paragraph{Normal Marginal Distribution}
...
\paragraph{Exponential Marginal Distribution}
