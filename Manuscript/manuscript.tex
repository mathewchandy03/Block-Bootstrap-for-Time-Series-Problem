...
described in \textit{Block Bootstrap CIs}. Then we estimated their actual coverage 
...
\jy{Could do one for the exponential margin study too. Maybe for the negative dependence.}
