...
\mc{we need eight to ten keywords, are the ones I added okay?}
\eds{These look fine to me.}
...
\eds{this is not usually how I see it written, but it looks correct now}
...
\begin{figure}[tbp]
  ...
  \caption{Empirical coverage rates of different 95\% block bootstrap CIs for
    the marginal standard deviation $\sigma_x$ \eds{$\sigma_w$?} of a stationary series with 
...
The empirical coverage rates for $\mu$, $\sigma_w$, \eds{define $\sigma_w$} and $\phi$, as well as 95\%
