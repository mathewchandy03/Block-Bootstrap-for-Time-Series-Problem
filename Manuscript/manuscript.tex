...
$\rho \in \{-0.4, -0.2, 0.0, 0.2, 0.4\} $using the \texttt{copula} package.
\citep{hofert2018ealements} Then we computed $E[XY]$, which 
requires double integration using the \texttt{pracma} package. \citep{pracma} 
