...
\mc{this observation was for lag-1 autocorrelation. does it still invalidate 
our effective sample size explanation?}
However, the other 
trends 
and patterns
...
\jy{Recall that t is not different from normal when sample size is
  ...
  better for small samples.} \mc{addressed}
