...
the new five autocorrelation coefficients for $W_t$ will be different.
\mc{I may need some help explaining the calibration of copula parameters}
After calibrating the copula parameters using the \textsl{copula} and 
\textsl{pracma} packages, \citep{copula, pracma} we can again plot empirical coverage 
rates and the 95\% confidence intervals of the real coverage.
