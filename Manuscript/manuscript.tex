...
\jy{Use a different symbol because $b$ has been used. Isn't is the same as $\hat
  z_0$ in the next paragraph?} \mc{addressed}
...
A $(1 - \alpha)100\%$ CI is
centered around $\hat\theta_n$ and can be rewritten as 
\[
